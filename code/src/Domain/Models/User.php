...
class User
{
    ...
    public static function getUserFromStorageById(int $id): User
    {
        ...
        return new User($result['user_name'], $result['user_lastname'], $result['user_birthday_timestamp'], $result['user_id']);
    }
    ...
    public function updateUser(int $userID, array $userDataArray): void
    {
